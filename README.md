...
```xml
VectemBuildTool [--config <BuildConfigFile> --platform <PlatformName> --dependency-projects <ProjectRootDir> <UnitName> <UnitType>...] <ProjectRootDir> <UnitName> <UnitType> <Target>
```
